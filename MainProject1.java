...
public class MainProject1 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            user = input.nextInt();
            if (user>9||user<1){
                System.out.println("you can't  add number lees than 1 or bigger than 9");
            }
            else {
    ...
    public static void gameValue(char [][] tic_tac,String turn,int Square){
        char ch=' ';
        ...
        switch (Square){
            ...
            case 9:
                ...
                break;
            default:
                System.out.println("enter 1-9 to add X in the Square");
                break;
        }
